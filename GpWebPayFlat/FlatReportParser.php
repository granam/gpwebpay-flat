...
class FlatReportParser extends StrictObject
{
    ...
    /**
     * @param ImapEmailAttachmentFetcher $imapEmailAttachmentFetcher
     * @param \DateTimeInterface $transactionsOfDay
    ...
    public function createFlatContentFromEmailAttachment(
        ImapEmailAttachmentFetcher $imapEmailAttachmentFetcher,
        \DateTimeInterface $transactionsOfDay,
     ...
     * @param \DateTimeInterface $ofDay
     * @return array
     */
    private function filterAttachments(array $attachments, \DateTimeInterface $ofDay): array
    {
        $filteredAttachments = [];
    ...
    {
        if (strtoupper(strpos($isoEncoding, (string) 3)) !== 'ISO' || strtoupper(substr(PHP_OS, 3)) !== 'WIN' /* windows */) {
            return $isoEncoding;
        }
